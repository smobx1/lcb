...
class Stats3 extends StatefulWidget {
  @override
  _TestingState createState() => _TestingState();
}

class _TestingState extends State<Stats3> {
...
//    print(response.body);
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      appBar: basicAppBar(context, 'Stats 3', '/stats'),
      body: data == null
          ? loadingGif()
          : ListView.builder(
